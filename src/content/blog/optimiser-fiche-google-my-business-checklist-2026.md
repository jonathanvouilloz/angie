...
- Les 5 quick wins à traiter en priorité cette semaine sont listés à la fin.

---

## Comment lire cette checklist : les signaux qui comptent vraiment en 2026
...
Pour la vue d'ensemble du pillar : [le guide complet sur la fiche Google My Business](/blog/fiche-google-my-business-guide-complet-2026).

---

## Section 1 : identité (points 1 à 5)

<!-- TODO:image infographic — Grille visuelle des 25 points de la checklist GMB groupés par section avec cases à cocher — brief: content/_drafts/blog/optimiser-fiche-google-my-business-checklist-2026.md#image-3 -->
...
## Section 2 : contenu (points 6 à 10)
...
## Section 3 : visuel (points 11 à 15)
...
## Section 4 : attributs (points 16 à 17)

Les attributs sont la section la plus ignorée par les PME. Et pourtant, Google les affiche directement dans la fiche et les utilise pour les recherches filtrées.
...
## Section 5 : horaires (points 18 à 19)

**Point 18 : horaires réguliers exacts**
...
## Section 6 : posts (point 20)

**Point 20 : cadence des posts Google My Business**

La **cadence des posts Google My Business** est un signal de fraîcheur direct. Minimum : 1 post par semaine. Les posts restent visibles 6 mois, mais ce n'est pas une raison de ne poster qu'une fois tous les 6 mois. Google observe la régularité, pas juste l'existence.

Trois types disponibles :
- **Nouveauté** : info générale, actualité de l'entreprise
- **Offre** : promotion avec date de début et fin
- **Événement** : borné dans le temps (salon, atelier, inauguration)
...
## Section 8 : maillage GBP et site web (points 24 à 25)

<!-- TODO:image schema — Avant/après d'une fiche GMB non optimisée vs optimisée, avec annotations des éléments améliorés — brief: content/_drafts/blog/optimiser-fiche-google-my-business-checklist-2026.md#image-4 -->

**Point 24 : NAP cohérent sur le site web**
...
## Par où commencer si tu pars de zéro (les 5 quick wins)

Tu as une fiche existante mais jamais vraiment optimisée ? Voici les 5 points à traiter **cette semaine**, dans cet ordre, pour un impact immédiat.

1. **Catégorie principale** (5 min) : vérifie qu'elle est la plus précise disponible. Impact : ranking immédiat sur les bonnes recherches.
2. **Description 750 caractères** (20 min) : rédige une description avec ville + service + différenciation. Impact : CTR depuis la fiche + signal GBP.
3. **5 photos fraîches** (30 min) : façade, intérieur, équipe, produit/service, logo. Impact : +42% demandes d'itinéraire en moyenne.
...
## FAQ sur l'optimisation d'une fiche Google My Business

### Combien de temps faut-il pour voir l'impact des optimisations GMB ?

Les effets sur les métriques GBP Insights (impressions, clics) se voient en 2 à 4 semaines. L'impact sur le ranking dans le Local Pack prend 4 à 8 semaines pour des optimisations majeures (catégorie, contenu) et peut être plus rapide pour des signaux de fraîcheur (posts, photos récentes).
...
Oui, mais indirect. Les attributs (accessibilité, identité) ne sont pas des facteurs de ranking directs. Ils augmentent la visibilité dans les recherches filtrées ("restaurants accessibles en fauteuil roulant" par exemple) et améliorent le taux de clic depuis la fiche. Un CTR plus élevé produit un signal behavioral qui améliore le ranking.
...
Vérification mensuelle des métriques GBP Insights. Mise à jour des horaires chaque trimestre (et avant chaque jour férié). Nouvelles photos : 1 par semaine minimum. Posts : 1 par semaine. Réponse aux avis : dans les 48h après chaque avis reçu.
...
[**Audit complet de ma fiche →**](/services/gestion-fiche-google?utm_source=blog&utm_medium=article&utm_campaign=optimiser-fiche-google-my-business-checklist-2026)
