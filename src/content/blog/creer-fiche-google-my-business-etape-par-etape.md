...
faqs:
  ...
  - question: "Que faire si ma catégorie principale n'existe pas dans la liste Google ?"
    answer: "La liste de catégories GBP est fixée par Google — tu ne peux pas créer de catégorie personnalisée. Dans ce cas, choisis la catégorie la plus proche de ton activité principale, puis affine avec les catégories secondaires."
  - question: "Comment changer de catégorie principale après la création ?"
    answer: "Depuis le dashboard GBP, Informations, Catégorie principale, modifier. Le changement est immédiat mais ses effets sur le ranking prennent 1 à 3 semaines à se matérialiser. Google observe la cohérence entre ta catégorie et le contenu de ton site avant de valider le nouveau positionnement."
---
...
Si tu pars vraiment de zéro, commence par lire [comment apparaître sur Google Maps si tu pars de zéro](/blog/comment-apparaitre-google-maps-pme-debutant) pour comprendre le contexte global. Ici, on entre dans le détail des 7 étapes.

Pour la vision d'ensemble du cluster GMB, [le guide complet sur la fiche Google My Business](/blog/fiche-google-my-business-guide-complet-2026) structure tout le paysage.

![Créer fiche Google My Business étape par étape — guide 2026](/images/blog/creer-fiche-google-my-business-etape-par-etape-1.webp)
...
<!-- TODO:image infographic — Roadmap des 7 étapes de création d'une fiche GBP avec numéros et étapes clés surlignées — brief: content/_drafts/blog/creer-fiche-google-my-business-etape-par-etape.md#image-2 -->
...
Pour aller plus loin sur les catégories secondaires et l'ensemble des optimisations : [la checklist complète pour optimiser ta fiche](/blog/optimiser-fiche-google-my-business-checklist-2026).

---

## Étape 3 : adresse physique ou zone de chalandise (et ce que ça change pour ton ranking)

<!-- TODO:image schema — Comparatif deux colonnes : Commerce avec adresse physique (épingle Maps, fort ranking Local Pack) vs Zone de service (zone colorée, ranking plus faible) — brief: content/_drafts/blog/creer-fiche-google-my-business-etape-par-etape.md#image-3 -->
...
Pour l'ensemble des optimisations à réaliser une fois la fiche créée : [la checklist complète pour optimiser ta fiche](/blog/optimiser-fiche-google-my-business-checklist-2026).
